...
export const gradientBgPurplePink = `${gradientBgBase} from-red-500 via-orange-500 to-yellow-500`
export const gradientBgDark = `${gradientBgBase} from-zinc-900 via-slate-900 to-zinc-800`
export const gradientBgPinkRed = `${gradientBgBase} from-orange-400 via-red-500 to-yellow-500`
